...
namespace BackendTests
{
    public class UserTests
    {
        ...
        public void Runtests()
        {
            ...
            CheckPasswordTest();
            Console.WriteLine("Get Active Tasks Test:");
        }
        ...
        {
            Response res0 = JsonSerializer.Deserialize<Response>(user.ChangePassword("omrymuadi2@gmail.com", "bbb"));
            if (res0.ErrorOccurd)
            {
            ...
            Response res2 = JsonSerializer.Deserialize<Response>(user.ChangePassword("omrymuadi2@gmail.com", "Im123"));
            if (res2.ErrorOccurd)
            {
            ...
            Response res3 = JsonSerializer.Deserialize<Response>(user.ChangePassword("omrymuadi2@gmail.com", "Im123"));
            if (res3.ErrorOccurd)
            {

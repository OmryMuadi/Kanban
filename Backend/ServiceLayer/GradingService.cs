...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    public class GradingService
    {
        ...
        public GradingService()
        {
            ...
            this.bs = new BoardService(this.us);
            this.ts = new TaskService(this.bs,this.us);
        }
        ...
        {
            return bs.GetColumnName(columnOrdinal, email, boardName);
        }
        ...
        {
            return bs.AddTask(email, boardName, title, dueDate, description);
        }
        ...
        {
            return ts.SetDueDate(email, boardName, columnOrdinal, taskId, dueDate);
        }
        ...
        {
            return ts.SetTitle(email, boardName, columnOrdinal, taskId, title);
        }
        ...
        {
            return ts.SetDescription(email,boardName, columnOrdinal, taskId, description);
        }
        ...
        {
            return bs.MoveStatus(taskId, boardName, columnOrdinal, email);
        }
        ...
        {
            return bs.GetColumn(columnOrdinal, email, boardName);
        }
        ...
        {
            return ts.InProgressTasks(email);
        }
        ...
        {
            return ts.AssignTask(email,boardName,columnOrdinal,taskID,emailAssignee);
        }
